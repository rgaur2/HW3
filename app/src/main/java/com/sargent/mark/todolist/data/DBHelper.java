 ...
 *
 * made changes in table defination and added two column two create tables
 * first one is category that is string and another one is status that is boolean datatype
 *
 * */
...
public class DBHelper extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase db) {
        String queryString = "CREATE TABLE " + Contract.TABLE_TODO.TABLE_NAME + " ("+
                ...
                Contract.TABLE_TODO.COLUMN_NAME_STATUS + " BOOLEAN NOT NULL DEFAULT FALSE,"+
